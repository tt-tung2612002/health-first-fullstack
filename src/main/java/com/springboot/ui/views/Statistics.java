package com.springboot.ui.views;

import com.springboot.ui.components.ListItem;
import com.springboot.ui.layout.size.*;
import com.springboot.ui.layout.size.Top;
import com.springboot.ui.util.*;
import com.springboot.ui.util.css.*;
import com.springboot.ui.util.css.Position;
...
import com.springboot.backend.Payment;
import com.springboot.ui.MainLayout;
import com.springboot.ui.components.DataSeriesItemWithRadius;
...
public class Statistics extends ViewFrame {
	...
	private FlexBoxLayout createHeader(VaadinIcon icon, String title) {
		...
		header.setMargin(com.springboot.ui.layout.size.Bottom.L, Horizontal.RESPONSIVE_L);
	...
	private Component createPaymentChart(Payment.Status status) {
		...
		paymentChart.setPadding(com.springboot.ui.layout.size.Bottom.S, Top.M);
		return paymentChart;
	}
	...
	private Component createReports() {
		...
		reports.setPadding(com.springboot.ui.layout.size.Bottom.XL, Left.RESPONSIVE_L);
		return reports;
	}
	...
	private Component createLogs() {
		...
		logs.setPadding(com.springboot.ui.layout.size.Bottom.XL, Right.RESPONSIVE_L);
		return logs;
	}
